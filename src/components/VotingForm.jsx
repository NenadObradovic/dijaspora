...
const VotingForm = ({ onSubmit }) => {
	...
	return (
		<div>
			<div className="tabs">
				<button onClick={() => setActiveTab('check')} className={activeTab === 'check' ? 'active' : ''}>
					{t('check_tab')}
				</button>
				<button onClick={() => setActiveTab('personal-data')} className={activeTab === 'personal-data' ? 'active' : ''}>
					{t('personal_data_tab')}
				</button>
				<button onClick={() => setActiveTab('signature')} className={activeTab === 'signature' ? 'active' : ''}>
					{t('signature_tab')}
				</button>
			</div>
			<form onSubmit={handleSubmit}>
				...
				{activeTab === 'signature' && (
					<>
						...
						<br />
						{data.signature && <button type="submit">{t('generate_request')}</button>}
					</>
				)}
